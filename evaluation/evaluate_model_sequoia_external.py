...
if __name__=='__main__':
    ...
    cancers = ['CPTAC_COAD', 'CPTAC_BRCA', 'CPTAC_LUAD']

    save_path_dir = os.path.join(model_dir, 'tRNAsformer_external')
    ...
    for cancer in cancers:
        print(cancer.upper())
        with open(os.path.join(f'./rna_ckpts/tRNAsformer/output/{cancer.upper()}/run_train_tRNAsformer_external', 'test_results.pkl'), 'rb') as f:
            test_res = pl.load(f)
        ...
        for k in range(folds):
            ...
            all_res.to_csv(os.path.join(save_path, f'all_genes_rr_{k}.csv'))

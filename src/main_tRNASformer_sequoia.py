...
from utils import filter_no_features, custom_collate_fn, load_patient_kfold
...
if __name__ == '__main__':
    ...
    for train_idx, val_idx in zip(train_idxs, val_idxs):
        ...
        preds, real, wsis, projs = evaluate(model, val_dataloader, run=run, suff='_'+str(i), cohort=args.cohort)
        ...
        random_preds, _, _, _ = evaluate(random_model, val_dataloader, run=run, suff='_'+str(i)+'_rand', cohort=args.cohort)
